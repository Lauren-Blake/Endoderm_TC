...
chimp_var_pval_red01 <- chimp_var_pval
...
p1 <- ggplot(chimp_var_pval_red01, aes(chimp_var_pval_red01[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  scale_x_continuous(limits = c(0,1)) +  labs(x = "Un-adjusted p-values") + labs(y = "Density") +
  geom_hline(yintercept = boot_pi0, size=2.5, colour = "#E77642") + 
  annotate("text", label='bold(bolditalic(hat(pi)[0][", chimp"])=="0.74")', parse=TRUE, x=0.91, y=(boot_pi0+0.19), size = 6, colour = "#E77642")
...
chimp_var_pval_red12 <- chimp_var_pval
...
p2 <- ggplot(chimp_var_pval_red12, aes(chimp_var_pval_red12[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  scale_x_continuous(limits = c(0,1)) +  labs(x = "Un-adjusted p-values") + labs(y = "Density") +
  geom_hline(yintercept = boot_pi0, size=2.5, colour = "#E77642") + 
  annotate("text", label='bold(bolditalic(hat(pi)[0][", chimp"])=="1")', parse=TRUE, x=0.10, y=(boot_pi0+0.19), size = 6, colour = "#E77642")
...
chimp_var_pval_red23 <- chimp_var_pval
...
pi0est(chimp_var_pval, lambda = seq(0.05, 0.95, 0.05))$pi0
pi0est(chimp_var_pval, lambda = seq(0.05, 0.80, 0.05))$pi0

qvalue(p=chimp_var_pval, lambda=seq(0,0.90,0.05), pi0.method="bootstrap", fdr.level=NULL, robust=TRUE, gui=FALSE, smooth.df=3, smooth.log.pi0=FALSE)$pi0

# Obtain pi_1 based on torey's pi_0

1 -pi0est(chimp_var_pval, lambda = seq(0.05, 0.95, 0.05))$pi0
...
p3 <- ggplot(chimp_var_pval_red23, aes(chimp_var_pval_red23[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  scale_x_continuous(limits = c(0,1)) +  labs(x = "Un-adjusted p-values") + labs(y = "Density") +
  geom_hline(yintercept = boot_pi0, size=2.5, colour = "#E77642") + 
  annotate("text", label='bold(bolditalic(hat(pi)[0][", chimp"])=="0.97")', parse=TRUE, x=0.10, y=(boot_pi0+0.19), size = 6, colour = "#E77642")
...
chimp_var_pval_red13 <- chimp_var_pval
...
human_var_pval_red01 <- human_var_pval
...
p4 <- ggplot(human_var_pval_red01, aes(human_var_pval_red01[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  ...
  annotate("text", label='bold(bolditalic(hat(pi)[0][", human"])=="0.23")', parse=TRUE, x=0.90, y=(boot_pi0+0.4), size = 6, colour = "#00A4F4")
...
human_var_pval_red12 <- human_var_pval
...
p5 <- ggplot(human_var_pval_red12, aes(human_var_pval_red12[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  scale_x_continuous(limits = c(0,1)) +  labs(x = "Un-adjusted p-values") + labs(y = "Density") +
  geom_hline(yintercept = boot_pi0, size=2.5, colour = "#00A4F4") + 
  annotate("text", label='bold(bolditalic(hat(pi)[0][", human"])=="1")', parse=TRUE, x=0.10, y=(boot_pi0+0.4), size = 6, colour = "#00A4F4")
...
human_var_pval_red23 <- human_var_pval
...
p6 <- ggplot(human_var_pval_red23, aes(human_var_pval_red23[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  scale_x_continuous(limits = c(0,1)) +  labs(x = "Un-adjusted p-values") + labs(y = "Density") + geom_hline(yintercept = boot_pi0, size=2.5, colour = "#00A4F4") + 
  annotate("text", label='bold(bolditalic(hat(pi)[0][", human"])=="0.95")', parse=TRUE, x=0.10, y=(boot_pi0+0.4), size = 6, colour = "#00A4F4")
...
p6s <- ggplot(human_var_pval_red23, aes(human_var_pval_red23[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  scale_x_continuous(limits = c(0,1)) +  labs(x = "Un-adjusted p-values") + labs(y = "Density") + geom_hline(yintercept = boot_pi0, size=2.5, colour = "#00A4F4") + 
  annotate("text", label='bold(bolditalic(hat(pi)[0][", human"])=="0.87")', parse=TRUE, x=0.10, y=(boot_pi0+0.4), size = 6, colour = "#00A4F4")
...
human_var_pval_red13 <- human_var_pval
...
```{r}
multiplot(p1,p4,p2,p5,p3,p6,p3_13, p6_13, cols=2)
...
p7 <- ggplot(chimp_var_pval, aes(chimp_var_pval[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  scale_x_continuous(limits = c(0,1)) +  labs(x = "Un-adjusted p-values") +
  geom_hline(yintercept = boot_pi0, size=2.5, colour = "#E77642") + 
  annotate("text", label='bold(bolditalic(hat(pi)[0][", chimp"])=="1")', parse=TRUE, x=0.10, y=(boot_pi0+0.19), size = 6, colour = "#E77642")
...
p8 <- ggplot(chimp_var_pval, aes(chimp_var_pval[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  scale_x_continuous(limits = c(0,1)) +  labs(x = "Un-adjusted p-values") + labs(y = "Density") + geom_hline(yintercept = boot_pi0, size=2.5, colour = "#E77642") + 
  annotate("text", label='bold(bolditalic(hat(pi)[0][", chimp"])=="0.57")', parse=TRUE, x=0.9, y=(boot_pi0+0.2), size = 6, colour = "#E77642")
...
# Make a histogram of the unadjusted p-values
hist(chimp_var_pval, main = c("Chimpanzees days 2 to 3"))
...
p9 <- ggplot(chimp_var_pval, aes(chimp_var_pval[,1])) + geom_histogram(aes(y = ..density..), fill="white", colour="black", breaks=seq(0, 1, by = 0.02)) + theme_bw() + 
  scale_x_continuous(limits = c(0,1)) +  labs(x = "Un-adjusted p-values") + labs(y = "Density") + geom_hline(yintercept = boot_pi0, size=2.5, colour = "#E77642") + 
  annotate("text", label='bold(bolditalic(hat(pi)[0][", chimp"])=="0.46")', parse=TRUE, x=0.9, y=(boot_pi0+0.4), size = 6, colour = "#E77642")
...
p1 <- ggplot(all_pval, aes(pval, fill = Species)) + scale_fill_manual(values=pal[2:3]) +
  ...
  annotate("text", label='italic(hat(pi)[0][", chimp"])=="0.73"', parse=TRUE, x=0.4, y=(pi0est_chimps+0.07)) +  annotate("text", label='italic(hat(pi)[0][", shared"])=="0.53"', parse=TRUE, x=0.4, y=(pi0est_chimps_given_humans+0.07))
...
p2 <- ggplot(all_pval, aes(pval, fill = Species)) + scale_fill_manual(values=pal[2:3]) +
  ...
  geom_hline(yintercept = pi0est_chimps_given_humans) + 
  geom_hline(yintercept = pi0est_chimps) +       
  annotate("text", label='italic(hat(pi)[0][", chimp"])=="1"', parse=TRUE, x=0.6, y=(pi0est_chimps+0.07)) +  annotate("text", label='italic(hat(pi)[0][", shared"])=="0.36"', parse=TRUE, x=0.6, y=(pi0est_chimps_given_humans+0.07))
...
p3 <- ggplot(all_pval, aes(pval, fill = Species)) + scale_fill_manual(values=pal[2:3]) +
  ...
  geom_hline(yintercept = pi0est_chimps_given_humans) + 
  geom_hline(yintercept = pi0est_chimps) +       
  annotate("text", label='italic(hat(pi)[0][", chimp"])=="0.90"', parse=TRUE, x=0.6, y=(pi0est_chimps-0.07)) +  annotate("text", label='italic(hat(pi)[0][", shared"])=="1"', parse=TRUE, x=0.6, y=(pi0est_chimps_given_humans+0.07))
...
p4 <- ggplot(all_pval, aes(pval, fill = Species)) + scale_fill_manual(values=pal[2:3]) +
  ...
  geom_hline(yintercept = pi0est_chimps_given_humans) + 
  geom_hline(yintercept = pi0est_chimps) +       
  annotate("text", label='italic(hat(pi)[0][", chimp"])=="1"', parse=TRUE, x=0.6, y=(pi0est_chimps+0.07)) +  annotate("text", label='italic(hat(pi)[0][", shared"])=="0.78"', parse=TRUE, x=0.6, y=(pi0est_chimps_given_humans+0.07))
...
p5 <- ggplot(all_pval, aes(pval, fill = Species)) + scale_fill_manual(values=pal[2:3]) +
  ...
  geom_hline(yintercept = pi0est_chimps_given_humans) + 
  geom_hline(yintercept = pi0est_chimps) +       
  annotate("text", label='italic(hat(pi)[0][", chimp"])=="1"', parse=TRUE, x=0.6, y=(pi0est_chimps+0.07)) +  annotate("text", label='italic(hat(pi)[0][", shared"])=="0.79"', parse=TRUE, x=0.6, y=(pi0est_chimps_given_humans+0.07))
...
p6 <- ggplot(all_pval, aes(pval, fill = Species)) + scale_fill_manual(values=pal[2:3]) +
  ...
  geom_hline(yintercept = pi0est_chimps_given_humans) + 
  geom_hline(yintercept = pi0est_chimps) +       
  annotate("text", label='italic(hat(pi)[0][", chimp"])=="0.52"', parse=TRUE, x=0.4, y=(pi0est_chimps+0.07)) +  annotate("text", label='italic(hat(pi)[0][", shared"])=="0.34"', parse=TRUE, x=0.4, y=(pi0est_chimps_given_humans+0.07))
...
### Permutation test to find the null hypothesis of sharing (reduction in chimps | significant in humans for day 0 to 1) 
...
return(shared_p0_given_permutation)
#print(i)
}

1-mean(shared_p0_given_permutation)

1-pnorm(0.47, (1-mean(shared_p0_given_permutation)), sd(shared_p0_given_permutation))
...
pi0est_chimps_given_humans <- pi0est(shared_p_values_gen, lambda = seq(0.05, 0.95, 0.05))$pi0
shared_p0_given_permutation_human[i,1] <- pi0est_chimps_given_humans
...
p1 <- ggplot(all_pval, aes(pval, fill = Species)) + scale_fill_manual(values=pal[2:3]) +
  ...
  annotate("text", label='italic(hat(pi)[0][", human"])=="0.17"', parse=TRUE, x=0.3, y=(pi0est_humans+0.07)) +  annotate("text", label='italic(hat(pi)[0][", shared"])=="0.16"', parse=TRUE, x=0.3, y=(pi0est_humans_given_chimps-0.06))
...
p6 <- ggplot(all_pval, aes(pval, fill = Species)) + scale_fill_manual(values=pal[2:3]) +
  ...
  geom_hline(yintercept = pi0est_humans_given_chimps) + 
  geom_hline(yintercept = pi0est_humans) +       
  annotate("text", label='italic(hat(pi)[0][", human"])=="0.21"', parse=TRUE, x=0.25, y=(pi0est_humans+0.07)) +  annotate("text", label='italic(hat(pi)[0][", shared"])=="0.09"', parse=TRUE, x=0.25, y=(pi0est_humans_given_chimps+0.07))

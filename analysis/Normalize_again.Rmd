...
gene_counts_combined_raw_data <-read.delim("~/Desktop/Endoderm_TC/ashlar-trial/data/gene_counts_combined.txt", header=TRUE)
...
#write.table(cpm_in_cutoff,file="~/Desktop/Endoderm_TC/ashlar-trial/data/gene_counts_combined_norm_data.txt",sep="\t", col.names = T, row.names = T)
